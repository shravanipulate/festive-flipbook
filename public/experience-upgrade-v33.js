...
.yt-result:hover{transform:translateY(-1px);background:rgba(127,127,127,.1)}
.yt-result img{width:58px;height:34px;object-fit:cover;border-radius:5px;flex-shrink:0}
.yt-result-info{min-width:0;flex:1}
  ...
  async function searchYouTubeBgm() {
    ...
    try {
      const url = 'https://www.googleapis.com/youtube/v3/search' +
        ...
        '&maxResults=5' +
        '&key=' + encodeURIComponent('AIzaSyC78Uq8hOGxYE4s46QPwgk9vHa122LRgoM');
